...
import { checkInstituteVerificationStatus } from '../controllers/instituteVerification.controller.js';
...
router.get('/verification-status', authenticateToken, checkInstituteVerificationStatus);
